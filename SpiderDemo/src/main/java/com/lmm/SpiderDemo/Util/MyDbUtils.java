...
public final class MyDbUtils {// 拒绝继承
	...
	private static String url = "jdbc:mysql://localhost:3306/spider?useUnicode=true&characterEncoding=utf-8";
	private static String user = "root";
	private static String password = "root";
	private static QueryRunner queryRunner = new QueryRunner();

	public static final String INSERT_LOG = "INSERT INTO DATA(goods_id,data_url,pic_url,title,price,param,`current_time`) VALUES(?,?,?,?,?,?,?)";
